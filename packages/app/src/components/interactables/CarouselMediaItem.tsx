...
function CarouselMediaSkeleton({ style }: { style?: ViewStyle }) {
	return (
		<View className={'carousel-item carousel-item'} style={style}>
			<View className={'carousel-item-ctn'}>
				<View className={'carousel-item-img'} />
			</View>
		</View>
	);
}

export { CarouselMediaSkeleton };
export default memo(CarouselMediaItem);
