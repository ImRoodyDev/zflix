...
import React2__default, { useReducer, useEffect, createContext, memo, useMemo, forwardRef, useRef, useCallback, useLayoutEffect, useImperativeHandle, useState, useContext } from 'react';
...
var LeanViewContext = React2.createContext(void 0);
var useLeanViewContext = () => {
  const context = React2.useContext(LeanViewContext);
  if (!context) {
...
// src/Container.tsx
var Container = ({ id, recycleItems, horizontal, getRenderedItem, updateItemSize, ItemSeparatorComponent }) => {
  const ctx = useStateContext();
  ...
  const refLastSize = useRef({ width: 0, height: 0 });
  const ref = useRef(null);
  const [layoutRenderCount, forceLayoutRender] = useState(0);
  const [parentLeanViewStyle, setParentLeanViewStyle] = useState({ zIndex: 0 });
  ...
  const updateZIndex = useCallback((index2) => {
  ...
  const contentFragment = /* @__PURE__ */ React2__default.createElement(React2__default.Fragment, { key: recycleItems ? void 0 : itemKey }, /* @__PURE__ */ React2__default.createElement(ContextContainer.Provider, { value: contextValue }, /* @__PURE__ */ React2__default.createElement(LeanViewContext.Provider, { value: { updateZIndex } }, renderedItem, renderedItemInfo && ItemSeparatorComponent && !lastItemKeys.includes(itemKey) && /* @__PURE__ */ React2__default.createElement(ItemSeparatorComponent, { leadingItem: renderedItemInfo.item }))));
  if (maintainVisibleContentPosition) {
    ...
    return /* @__PURE__ */ React2__default.createElement(LeanView, { style: [style, parentLeanViewStyle] }, /* @__PURE__ */ React2__default.createElement(LeanView, { style: [anchorStyle, paddingStyles], onLayout, ref }, contentFragment, __DEV__ && ENABLE_DEVMODE));
  }
  return /* @__PURE__ */ React2__default.createElement(LeanView, { style: [style, parentLeanViewStyle], onLayout, ref }, contentFragment);
};
...
var Containers = typedMemo(function Containers2({
  ...
  return /* @__PURE__ */ React2.createElement(Animated.View, { style: [style, {}] }, containers);
});
...
var ListComponent = typedMemo(function ListComponent2({
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    !ListEmptyComponent && (/* @__PURE__ */ React2.createElement(PaddingAndAdjust, null)),
...
export { LegendList, useIsLastItem, useLeanViewContext, useRecyclingEffect, useRecyclingState, useViewability, useViewabilityAmount };
